"""Static release-asset validation for the BLIP image-captioning DIMER pipeline.
...
EXPECTED_OUTPUTS = (
    ...
    "outputs/blip_captioning_annotated.png",
)
...
MARKDOWN_MARKERS = (
    ...
    "**Weight-format note:**",
    "Two **caller-owned request parameters** are exposed",
    "**No score exists**",
