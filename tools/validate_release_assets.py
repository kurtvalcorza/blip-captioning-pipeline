"""Static release-asset validation for the BLIP image-captioning-base DIMER pipeline.
...
EXPECTED_MODEL_ID = "Salesforce/blip-image-captioning-base"
...
KNOWN_SHAS: frozenset[str] = frozenset(
    ("c4a6d897836e7885d0095134f92d392e4e770539",)  # the pinned VizWiz-Captions dataset revision, cited beside the model revision
)
BYOD_GATES = ("USE_BYOD",)
EXPECTED_OUTPUTS = (
    "outputs/blip_captioning_train.jsonl",
    "outputs/blip_captioning_input_manifest.json",
    "outputs/blip_captioning_evaluation_report.json",
    "outputs/blip_captioning_captions.csv",
    "outputs/blip_captioning_adapter",
    "outputs/blip_captioning_result.json",
)
CODE_MARKERS = (
    # Stage 4: pinned captions + pinned photographs from one row group, image-disjoint split, validation, JSONL, refusal probes
    "USE_BYOD = False",
    ...
    "write_dataset_jsonl(splits['train'], 'outputs/blip_captioning_train.jsonl')",
    ...
    # Stage 9: the scenes re-captioned, artifact, reload parity, provenance
...
MARKDOWN_MARKERS = (
    "**Capability:** image captioning and bounded supervised fine-tuning",
    "**BSD-3-Clause**",
    "**No score exists**",
